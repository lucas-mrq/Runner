...
public class Hero extends AnimatedThing {
    private double indexMax = 6;
    private static double indexPlayer = 0;
    private double affX;
    private double xMenue=0;
    private double tir=0;

    public Hero(String nameFile, double x, double y, double largeur, double hauteur) {
        super(nameFile, x, y, largeur, hauteur, 0,100);
    }
    ...
    public void updateMenue() {
        ...
        getAnimatedView().setX(xMenue%800);
        setAffX(x);
        setY(230);
        setHitBox(new Rectangle2D(85*((int) indexPlayer/5),0,85,100));
        getAnimatedView().setViewport(getHitBox());
